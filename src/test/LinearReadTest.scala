...
object LinearReadTest
{
    def main( argv : Array[String] ) : Unit =
    {
        ...
        val region = UserRegion.fromFile[MeshValue]( "P2BRP001-H653-Grown", configStrings._1 )
        ...
        val triquadNodes : ParameterEvaluator[ValueSource[MeshValue]] = region.getObject( "node.coordinates" )
        val nodeArgument : ArgumentEvaluator[ValueSource[MeshValue]] = region.getObject( "nodes.argument" )
        val rc3Argument : ArgumentEvaluator[ValueSource[MeshValue]] = region.getObject( "rc3.component" )
